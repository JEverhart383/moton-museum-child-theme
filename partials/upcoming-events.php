...
<div class="row mt-5">
  <div class="col-lg-12">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <img src="<?php echo $upcoming_events['featured_events'][0]['featured_image'] ?>" alt="<?php echo $upcoming_events['featured_events'][0]['featured_image_alt'] ?>" class="fluid">
      </div>
      </div>
    <?php endif; ?>
    <?php if(count($upcoming_events['regular_events']) > 0 ): ?>
      <div class="row child-card-container">
        <?php foreach($upcoming_events['regular_events'] as $event): ?>
          ...
          <div class="card">
            <img src="<?php echo $event['featured_image'] ?>" alt="<?php echo $event['featured_image_alt'] ?>" class="card-img-top">
